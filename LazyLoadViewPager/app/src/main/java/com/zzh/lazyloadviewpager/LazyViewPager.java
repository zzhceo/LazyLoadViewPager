...
public class LazyViewPager extends ViewGroup {
    ...
    // add by zzh is forbid horizontal switch tab enable
    ...
    /**
     * Like {@link View#scrollBy}, but scroll smoothly instead of * immediately. * * @param x * the number of pixels to scroll by on the X axis * @param y * the number of pixels to scroll by on the Y axis
     */
    ...
    // add by zzh for forbid horizontal scroll
